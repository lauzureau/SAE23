...
<body>
  <div class="container mt-3">
    <?php pagenavbar(); pageheader("Nos partenaires"); ?>
      ...
      <div class="col">
        <div class="container2">
          <div class="card">
            ...
            <div class="overlay2">
              <div class="text2">Artiste : XCOPY <br>Nom de l'oeuvre: Vault<br>Type: Edition <br>Edition: 1/100 <br>Licence: CC0<br>Owner: ArtiVault<br>Platform: KnownOrigin<br>Blockchain: Ethereum<br>Minted: 21/10/18<br></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="container4">
          <div class="card">
            ...
            <div class="overlay4">
              <div class="text">Autheur : Mad Dog Jones <br>Nom de l’œuvre REPLICATOR</div>
            </div>
          </div>
        </div>
      </div>
